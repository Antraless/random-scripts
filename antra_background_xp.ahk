...
UpdateOverlay:
    if WinExist("ahk_exe destiny2.exe") {
		...
		if (overlay.BeginDraw()) { 
			switch status {
				case 0:
					overlay.drawText("| F4 - Start | F5 - Stop | F8 - Close | support/more scripts: https://discord.gg/KGyjysA5WY", 10, 0, font_size, 0xFFFFFFFF, "Courier")
				case 1:
					overlay.drawText("| You may now tab out, if you want | F5 - Stop | F8 - Close |", 10, 0, font_size, 0xFFFFFFFF, "Courier")
			}
			overlay.EndDraw()
		}
	}
